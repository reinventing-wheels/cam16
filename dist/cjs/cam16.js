...
const cie1931_1 = require("./illuminants/cie1931");
const forward_1 = require("./transforms/forward");
...
const interp_F = util_1.interp([0.525, 0.590, 0.690], [0.800, 0.900, 1.000]);
class CAM16 {
    constructor(c = 0.69, Y_b = 20, L_A = 64 / math_1.PI / 5, wp = cie1931_1.D65) {
        const Y_w = wp[1];
        const F = interp_F(c);
        this.c = c;
        this.N_c = F;
        ...
        const k4 = k * k * k * k;
        const l4 = 1 - k4;
        this.F_L = k4 * L_A + 0.1 * l4 * l4 * math_1.cbrt(5 * L_A);
        this.n = Y_b / Y_w;
        this.z = 1.48 + math_1.sqrt(this.n);
        ...
        const D = math_1.max(0.0, math_1.min(1.0, F * (1 - 1 / 3.6 * math_1.exp((-L_A - 42) / 92))));
    ...
    fromXYZ([X, Y, Z]) {
        ...
        return forward_1.forward(this, RGB_c);
    }
    toXYZ(data, description) {
        const [R_c, G_c, B_c] = reverse_1.reverse(this, data, description);
